...
//////////////////add by lichq///////////////////////
+ (RTSPMessage*) createWithString:(NSString *) string
{
    RTSPMessage* msg = [[RTSPMessage alloc] initWithString:string];
    return msg;
}

- (RTSPMessage*) initWithString:(NSString *) msg
{
    //NSLog(@"开始构建RTSPMessage");
    self = [super init];
    ...
    NSString *Session = [self valueForOption:@"Session"];
    if (Session == nil)
    {
        Session = @"none";
    }
